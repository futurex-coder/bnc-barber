            ...
            >
              ...
              <RevealItem className="flex flex-col gap-5">
                <div className="flex flex-col gap-1">
                  <span className="text-sm uppercase tracking-[0.2em] text-gold">{b.role}</span>
                ...
                <RichText html={b.bio} className="max-w-md text-lg leading-relaxed text-grey" />
                ...
                <dl className="flex gap-8 border-y border-hairline py-4">
                  <div>
                    ...
                    <dd className="font-display text-2xl text-ink">{b.yearsExperience}+ г.</dd>
                  </div>
                  {b.locationName ? (
                    <div>
                      <dt className="text-xs uppercase tracking-wide text-grey">Локация</dt>
                      <dd className="font-display text-2xl text-ink">{b.locationName}</dd>
                    </div>
                  ) : null}
                </dl>
                ...
                <div className="flex flex-wrap items-center gap-3">
                  <FreshaButton
                    href={b.bookingUrl || b.locationFreshaUrl}
                    size="lg"
